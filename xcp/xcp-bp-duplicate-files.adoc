...
link:xcp-bp-using-the-xcp-data-mover-to-migrate-large-files.html["上一篇：使用XCP Data Mover移轉大型檔案。"]
...
....
link:xcp-bp-specific-date-based-scan-and-copy-of-data.html["下一步：特定日期型掃描與資料複本。"]
