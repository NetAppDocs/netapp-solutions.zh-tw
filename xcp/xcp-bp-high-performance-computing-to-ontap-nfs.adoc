...
如需使用 NetApp XCP 將 MapR-FS 資料移至 ONTAP NFS 的詳細步驟、請參閱附錄 A ： GPFS 至 NFS https://docs.netapp.com/us-en/netapp-solutions/data-analytics/bda-ai-introduction.html[] 、詳細步驟請參閱。
