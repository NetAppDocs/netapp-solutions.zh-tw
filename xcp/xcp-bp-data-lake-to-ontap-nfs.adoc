...
如需詳細的客戶使用案例、錄製的示範和測試結果、請參閱 https://["使用XCP將資料從資料湖和高效能運算移至ONTAP 支援NFS"^] 部落格：

如需ONTAP 使用NetApp XCP將MapR-FS資料移至Rse-NFS的詳細步驟、請參閱中的附錄B https://["TR-4732：Big Data Analytics Data to Artificial Intelligence"^]。
