...
* link:vmware_vcf_asa_supp_mgmt_iscsi.html#deployment-steps["VMware vSphere 主機部署於每部主機的雙儲存架構（兩個 HBA 或雙 VLAN 用於 iSCSI ）"]。
...
* link:vmware_vcf_asa_supp_mgmt_iscsi.html#deployment-steps["儲存 VM 和生命都可用"]
