...
image::stgr-splunkss-image10.png[stgr splunkss 影像 10.]
...
image::stgr-splunkss-image11.png[stgr splunkss 影像 11.]
...
image::stgr-splunkss-image12.png[stgr splunkss 影像 12.]
...
image::stgr-splunkss-image13.png[stgr splunkss 影像 13.]

我們從叢集主機收集效能資訊。尖峰效能為61.34GBps。

image::stgr-splunkss-image14.png[stgr splunkss 影像 14.]

平均效能約29 GBps。

image::stgr-splunkss-image15.png[stgr splunkss 影像 15.]
...
image::stgr-splunkss-image16.png[stgr splunkss 影像 16.]

當查詢執行StorageGRID 以供搜尋時、S3擷取速度的時間會StorageGRID 顯示在下列影像中。

image::stgr-splunkss-image17.png[stgr splunkss 影像 17.]
...
image::stgr-splunkss-image18.png[stgr splunkss 影像 18.]
