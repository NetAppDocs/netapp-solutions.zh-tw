...
* link:https://docs.netapp.com/us-en/netapp-solutions/virtualization/vsphere_ontap_best_practices.html#vsphere-datastore-and-protocol-features["NetApp ONTAP 支援所有儲存傳輸協定"]
...
* link:../ehc/aws/aws-migrate-vmware-hcx.html["使用 VMware HCX 將工作負載移轉至 FSX ONTAP 資料存放區"]
* link:../ehc/azure/azure-migrate-vmware-hcx.html["使用 VMware HCX 將工作負載移轉至 Azure NetApp Files 資料存放區"]
* link:../ehc/gcp/gcp-migrate-vmware-hcx.html["使用 VMware HCX 將工作負載移轉至 Google Cloud 上的 NetApp Cloud Volume Service 資料存放區 VMware Engine"]
...
* link:../containers/tanzu_with_netapp/vtwn_solution_overview.html["適用於 VMware Tanzu 的 NetApp 解決方案"]
...
* link:https://docs.netapp.com/us-en/netapp-solutions/virtualization/vvols-overview.html["VVols 技術文件"]
...
* link:vsrm-ontap9_1._introduction_to_srm_with_ontap.html["VMware Site Recovery Manager搭配NetApp ONTAP 功能9"]
...
* link:../ehc/aws/index.html["適用於 AWS VMware Cloud （ VMC ）的 NetApp 解決方案"]
* link:../ehc/azure/index.html["適用於Azure VMware解決方案（AVS）"]
