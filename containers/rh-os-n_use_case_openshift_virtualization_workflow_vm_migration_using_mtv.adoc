...
image::rh-os-n_use_case_vm_migration_using_mtv.png[使用 MTV 進行 RH OS n 使用案例 VM 移轉]
...
image::rh-os-n_use_case_vm_migration_source_provider.png[RH OS n 使用案例 VM 移轉來源供應商]
...
image::rh-os-n_use_case_vm_migration_using_mtv_plan_ready.png[使用已備妥 MTV 計畫的 RH OS n 使用案例 VM 移轉]

按一下 * 「開始」 * 將會執行一系列步驟、以完成虛擬機器的移轉。

image::rh-os-n_use_case_vm_migration_using_mtv_plan_complete.png[使用案例 VM 移轉的 RH OS n 使用案例、使用 MTV 計畫完成]
