...
最新版的 Trident 是 2022 年 1 月發行的 22.01 版。Trident 版本已通過測試的支援對照表，可以找到 Kubernetes 發佈版本 https://docs.netapp.com/us-en/trident/trident-get-started/requirements.html#supported-frontends-orchestrators["請按這裡"]。
