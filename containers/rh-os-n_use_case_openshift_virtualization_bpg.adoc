...
如需從 vSphere 移轉 VM 的詳細資訊、請參閱link:https://docs.netapp.com/us-en/netapp-solutions/containers/rh-os-n_use_case_openshift_virtualization_workflow_vm_migration_using_mtv.html["工作流程 gt; Red Hat OpenShift NetApp ONTAP 虛擬化"]
