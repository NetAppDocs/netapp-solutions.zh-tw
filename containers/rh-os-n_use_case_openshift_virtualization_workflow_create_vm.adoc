...
image::rh-os-n_use_case_vm_create_1.png[RH OS n 使用案例 VM 建立 1]

image::rh-os-n_use_case_vm_create_2.png[RH OS n 使用案例 VM 建立 2.]

image::rh-os-n_use_case_vm_create_3.png[RH OS n 使用案例 VM 建立 3.]

image::rh-os-n_use_case_vm_create_4.png[RH OS n 使用案例 VM 建立 4.]

image::rh-os-n_use_case_vm_create_5.png[RH OS n 使用案例 VM 建立 5.]
