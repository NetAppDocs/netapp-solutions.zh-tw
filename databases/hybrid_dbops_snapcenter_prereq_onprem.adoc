...
請遵循下列指示、為RedHat或CentOS機器設定Ansible控制節點： link:../automation/automation_rhel_centos_setup.html["RedHat/CentOS Ansible控制器設定"^]。
請遵循下列指示、為Ubuntu或Debian機器設定Ansible控制節點： link:../automation/automation_ubuntu_debian_setup.html["Ubuntu / Debian Ansible控制器設定"^]。
