...
* link:https://docs.netapp.com/us-en/netapp-solutions/databases/automation_ora_anf_nfs.html["Azure NetApp Files with NFS 上簡化的自動化 Oracle 部署"^]
* link:https://docs.netapp.com/us-en/netapp-solutions/databases/azure_ora_nfile_usecase.html#overview["Oracle資料庫部署Azure NetApp Files 與保護功能"^]
