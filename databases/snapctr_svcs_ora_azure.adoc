...
. 審查與 * 新增 * 。 影像： snapctr_svcs_centical_04-azure.png ["GUI 中顯示此步驟的螢幕擷取畫面。 ]
. 您可能還需要將 * Marketplace Subscription* 與認證建立關聯。 影像： snapctr_svcs_centical_05-azure.png ["GUI 中顯示此步驟的螢幕擷取畫面。 ]
