...
* 使用現有的Google Cloud VMware Engine軟體定義資料中心（SDDC）、或使用此功能建立私有雲端 https://docs.netapp.com/us-en/netapp-solutions/ehc/gcp-setup.html["NetApp連結"^] 或是這種情況 https://cloud.google.com/vmware-engine/docs/create-private-cloud["Google連結"^]。
