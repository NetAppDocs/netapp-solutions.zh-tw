...
[NOTE]
====
NetApp儲存設備即資料存放區目前可在所有大型超大規模雲端中以私有預覽形式提供。如需詳細資訊、請參閱下列連結。

link:https://blogs.vmware.com/cloud/2021/12/01/vmware-cloud-on-aws-going-big-reinvent2021/["FSX ONTAP 支援AWS原生資料存放區"]
link:https://azure.microsoft.com/en-us/updates/azure-netapp-files-datastores-for-azure-vmware-solution-is-coming-soon/["Azure的原生資料存放區Azure NetApp Files"]
