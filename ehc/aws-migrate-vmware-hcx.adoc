...
image::fsx-hcx-image1.png[FSX HCx 影像 1.]
...
+
image::fsx-hcx-image2.png[FSX HCx 影像 2.]
...
+
image::fsx-hcx-image5.png[FSX HCx 影像 5.]
...
+
image::fsx-hcx-image7.png[FSX HCx 影像 7.]
...
image::fsx-hcx-image8.png[FSX HCx 影像 8.]
...
+
image::fsx-hcx-image11.png[FSX HCx 影像 11.]

+
image::fsx-hcx-image12.png[FSX HCx 影像 12.]
...
+
image::fsx-hcx-image13.png[FSX HCx 影像 13.]
...
+
image::fsx-hcx-image14.png[FSX HCx 影像 14.]
...
+
image::fsx-hcx-image15.png[FSX HCx 影像 15.]
...
+
image::fsx-hcx-image16.png[FSX HCx 影像 16.]

. 選取要啟動的服務、然後按一下「Continue（繼續）」。
+
image::fsx-hcx-image17.png[FSX HCx 影像 17.]
...
+
image::fsx-hcx-image18.png[FSX HCx 影像 18.]
...
image::fsx-hcx-image19.png[FSX HCx 影像 19.]
...
+
image::fsx-hcx-image20.png[FSX HCx 影像 20.]

. 在移轉虛擬機器精靈中、選取遠端站台連線（目標VMC SDDC）。
+
image::fsx-hcx-image21.png[FSX HCx 影像 21.]

. 新增群組名稱、並在「Transfer and Placement（傳輸和放置）」下更新必填欄位（叢集、儲存設備和目的地網路）、然後按一下「Validate（驗證）」。
+
image::fsx-hcx-image22.png[FSX HCx 影像 22.]
...
+
image::fsx-hcx-image23.png[FSX HCx 影像 23.]
