...
image::gcve-deploy-1.png[gcve 部署 1.]
...
image::gcve-access-1.png[gcve 存取 1.]
...
image::gcve-access-2.png[gcve 存取 2.]
...
image::gcve-access-3.png[gcve 存取權限 3.]

image::gcve-access-4.png[gcve 存取 4.]
