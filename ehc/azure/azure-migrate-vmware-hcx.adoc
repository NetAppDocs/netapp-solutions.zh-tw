...
如需深入瞭解此程序、歡迎使用 link:https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=255640f5-4dff-438c-8d50-b01200f017d1["請依照詳細的逐步解說影片進行"]。

以下是HCX vMotion選項的快照。

image:anfd-hcx-image20.png["錯誤：缺少圖形影像"]

如需深入瞭解此程序、歡迎使用 link:https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=986bb505-6f3d-4a5a-b016-b01200f03f18["請依照詳細的逐步解說影片進行"]。
