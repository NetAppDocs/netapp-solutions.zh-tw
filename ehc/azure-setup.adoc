...
. 如果資源供應商尚未登錄、請選取「註冊」。
+
image::avs-register-create-pc-1.png[AVS 暫存器建立 PC 1]

+
image::avs-register-create-pc-2.png[AVS 暫存器建立 PC 2]
...
image::avs-register-create-pc-3.png[AVS 暫存器建立 PC 3.]
...
image::avs-register-create-pc-4.png[AVS 暫存器建立 PC 4.]
...
+
image::azure-connect-gateway-1.png[Azure Connect 閘道 1]

. 提供或更新新vnet的資訊、然後選取「確定」。


image::azure-connect-gateway-2.png[Azure Connect 閘道 2]
...
image::azure-validate-network-1.png[Azure 驗證網路 1]

虛擬機器佈建完成後、請使用「Connect（連線）」選項來存取RDP。

image::azure-validate-network-2.png[Azure 驗證網路 2]
...
image::azure-validate-network-3.png[Azure 驗證網路 3]
...
image::azure-validate-network-4.png[Azure 驗證網路 4]

image::azure-validate-network-5.png[Azure 驗證網路 5.]
