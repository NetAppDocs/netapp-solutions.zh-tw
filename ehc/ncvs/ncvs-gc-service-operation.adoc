...
Cloud Volumes Services for Google Cloud目前已通過ISO/IEC 27001：2013和ISO/IEC 27018：2019標準的認證。該服務最近也收到SOC2類型I證明報告。如需NetApp對資料安全性與隱私權承諾的相關資訊、請參閱 https://["法規遵循：資料安全與資料隱私"^]。



== GDPR

我們對隱私權和遵守GDPR的承諾、已在我們的多個公司中提供  https://["客戶合約"^]、例如我們的 https://["客戶資料處理附錄"^]、其中包括  https://["標準合約條款"^] 由歐盟委員會提供。我們也會在隱私權政策中做出這些承諾、並以公司行為準則中所列的核心價值為後盾。
