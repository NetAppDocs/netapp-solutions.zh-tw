...
image:aipod_nv_BaseCommand.png["錯誤：缺少圖形影像"]
...
•快速配置新的高容量 JupyterLab 工作區、並以高效能橫向擴充 NetApp 儲存設備作為後盾。
•快速佈建以企業級 NetApp 儲存設備為後盾的新 NVIDIA Triton Inference Server 執行個體。
