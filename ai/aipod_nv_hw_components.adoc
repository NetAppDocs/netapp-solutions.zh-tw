...
image::aipod_nv_basepod_layers.png[aipod nv 基 Pod 層]
...
image::aipod_nv_H100_rear.png[aipod nv H100 背面]
...
image::aipod_nv_SN4600_hires_smallest.png[aipod nv SN4600 的招募規模最小]
