...
image:aipod_nv_a90_netdetail.png["錯誤：缺少圖形影像"]
...
image:aipod_nv_a90_logical.png["錯誤：缺少圖形影像"]
...
*** net int create -vserver baspoe-data -lif c2-6B-lif2 -home-node-a90-02 AFF -home-port e6b -address 100.127.202.106 -netmask 255 ． 255 ． 255 ． 255 ． 255 ． 255 ． 255 ． 0
*** net int create -vserver baspoe-data -lif c2-11a-lif1 -home-node-a90-02 AFF -home-port e11a -address 100.127.102.107 -netmask 255 ． 255 ． 255 ． 255 ． 255 ． 255 ． 0
*** net int create -vserver baspoe-data -lif c2-11a-lif2 -home-node-a90-02 AFF -home-port e11a -address 100.127.102.108 -netmask 255 ． 255 ． 255 ． 255 ． 255 ． 255 ． 0
