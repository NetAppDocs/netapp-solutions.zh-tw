...
| link:containers/devops_with_netapp/dwn_solution_overview.html["採用NetApp Astra的DevOps"] | link:containers/rh-os-n_videos_astra_control_flexclone.html["影片：利用Astra Control和NetApp FlexClone技術加速軟體開發"] 
