...
請參閱link:../../ontap/ontap-security-hardening/security-hardening-overview.html["ONTAP 強化指南"]、link:../../ontap/multi-admin-verify/index.html["多管理員驗證總覽"^]和link:https://www.netapp.com/media/17055-tr4647.pdf["ONTAP 多因素驗證指南"^]以瞭解如何完成這些強化步驟。
